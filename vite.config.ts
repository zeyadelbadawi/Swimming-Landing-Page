...
process.env.VITE_APP_TITLE ??= process.env.OVERVIEW_TITLE ?? 'Swim City Academy';
process.env.VITE_APP_DESCRIPTION ??= process.env.OVERVIEW_DESCRIPTION ?? 'Swim City Academy';
